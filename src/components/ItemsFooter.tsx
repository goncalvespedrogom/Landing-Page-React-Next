...
export function ItemsFooter() {
  return (
    <div className="flex flex-col text-center xl:text-left sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-6 xl:px-0 xl:mr-[-3rem] px-5 pt-14 pb-8 xl:py-16 w-full mx-auto">
